<x-app-layout>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900">{{ __('cruds.permission.title_singular') }} {{ __('global.list') }}</h3>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 datatable datatable-Permission">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                {{ __('cruds.permission.fields.title') }}
                            </th>
                            <th scope="col" class="px-6 py-3">
                                {{ __('cruds.permission.fields.description') }}
                            </th>
                            <th scope="col" class="px-6 py-3">
                                &nbsp;
                            </th>
